...
var chunk_KTRPUNDQ_exports = {};
__export(chunk_KTRPUNDQ_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_KTRPUNDQ_exports);
...
var import_p_map = (0, import_chunk_2KG5ATHU.__toESM)((0, import_chunk_JLB3TCWY.require_p_map)());
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_JNJ6LKXB.getRootCacheDir)();
    if (!rootCacheDir) {
